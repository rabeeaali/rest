<x-guest-restaurant-layout title="Register">
    <div class="flex flex-wrap w-full">
        <div class="flex flex-col w-full md:w-1/2">
            ...
            <div class="flex flex-col justify-center px-8 pt-8 my-auto md:justify-start md:pt-0 md:px-24 lg:px-32">
                ...
                <form id="form-data" action="{{ route('restaurant.register') }}" method="post"
                    ...
                    <div class="flex flex-col pt-4">
                        <div class="flex relative">
                            ...
                            <input type="name" id="design-login-name" name="name" value="{{ old('name') }}"
        ...
        <div class="w-1/2 shadow-2xl">
            <img class="hidden object-cover w-full h-screen md:block" loading="lazy"
                src="{{ asset('images/restaurant_bg.jpg') }}" />
        </div>
    </div>
